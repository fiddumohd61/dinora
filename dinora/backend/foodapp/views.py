...
from .models import Restaurant, FoodItem, Cart, CartItem, Order, OrderItem, Review, Offer, Food
...
def restaurant_detail(request, id):
    ...
    return render(
        request,
        "foodapp/restaurant_detail.html",
        context
    )
